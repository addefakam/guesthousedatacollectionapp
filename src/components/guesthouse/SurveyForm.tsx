    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>Available facilities at the establishment</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="hasRestaurant" checked={formData.hasRestaurant} onCheckedChange={(c) => handleCheckboxChange('hasRestaurant', c === true)} />
              <Label htmlFor="hasRestaurant" className="cursor-pointer">Restaurant</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="hasParking" checked={formData.hasParking} onCheckedChange={(c) => handleCheckboxChange('hasParking', c === true)} />
              <Label htmlFor="hasParking" className="cursor-pointer">Parking</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="hasWiFi" checked={formData.hasWiFi} onCheckedChange={(c) => handleCheckboxChange('hasWiFi', c === true)} />
              <Label htmlFor="hasWiFi" className="cursor-pointer">WiFi</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="hasHotWater" checked={formData.hasHotWater} onCheckedChange={(c) => handleCheckboxChange('hasHotWater', c === true)} />
              <Label htmlFor="hasHotWater" className="cursor-pointer">Hot Water</Label>
            </div>
          </div>
          <div className="space-y-2">
            <Label htmlFor="additionalServices">Additional Services</Label>
            <Textarea id="additionalServices" name="additionalServices" placeholder="Laundry, airport shuttle, conference room, etc." value={formData.additionalServices} onChange={handleChange} rows={2} />
          </div>
        </CardContent>
      </Card>
